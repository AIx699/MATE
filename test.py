...
MODEL_LOCATION ='/content/drive/MyDrive/Novel/Arch/ckpt/0.002_16_tiny/'
MODEL_NAME = 'model113-x3d'
MODEL_EXTENSION = '.pth'
...
if __name__ == '__main__':
    ...
    if args.model_arch == 'base':
        model = Model(dim=32, num_blocks=1)
    elif args.model_arch == 'fast' or args.model_arch == 'tiny':
        model = Model(dim=8, num_blocks=1, dropout=0.29)
    else:
